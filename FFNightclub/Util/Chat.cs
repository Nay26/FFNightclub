...
namespace Util
{
    ...
    public class Chat
    {
        ...
        internal Chat()
        {
            if (FFNightClub.FFNightClub.SigScanner.TryScanText(Signatures.SendChat, out var processChatBoxPtr))
            {
            ...
            unsafe
            {
                if (FFNightClub.FFNightClub.SigScanner.TryScanText(Signatures.SanitiseString, out var sanitisePtr))
                {
